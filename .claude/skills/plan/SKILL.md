...
**Step 0 — Dependencies.** Establish repository access. Load only dependencies explicitly required by repository governance or the selected path. Classify planning mode: GREENFIELD (no existing
