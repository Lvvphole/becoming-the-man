...
- `.claude/skills/` — agent skills (engineering-rules). Each skill folder contains a `SKILL.md` and optional `references/` or `scripts/`. Read `SKILL.md` on trigger; read references only when cited.
